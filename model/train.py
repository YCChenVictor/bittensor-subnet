...
# movement = Movement(f"{washed_train_dir}/{predict_symbol}.csv", movement_filename, "value")
...
model_trainer = ModelTrainer(
    movement, roll_conn, past_roll_conn_period, raw_train_dir, "trained_model.keras"
)
model_trainer.process_data()
model_trainer.match()
model_trainer.train()
